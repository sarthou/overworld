...
namespace owds::physx {
  ...
  public:
    ...
    void setVelocity(const std::array<float, 3>& linear_velocity, const std::array<float, 3>& angular_velocity) override = 0;

    owds::AABB_t getAABB() override;
    owds::AABB_t getLocalAABB() override;
